...
const ExtractDisplay: React.FC = () => {
  const handleDownload = () => {
    ...
    saveAs(blob, "assin-manso-extract.docx");
  };
  return (
    <section className="relative bg-white py-20">
      {/* <div className="absolute inset-0 bg-[url('./transBg.png')] opacity-5 z-0"></div> */}
      <div className="z-20 flex flex-col md:flex-row h-screen p-8">
        ...
        <div className="md:w-2/3 bg-white rounded-lg shadow-lg p-6 overflow-hidden">
